        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          {!clientReady ? (
            ...
            <div className="relative">
              ...
              {profileOpen && (
                <div className="absolute right-0 top-11 w-64 rounded-xl bg-white border border-gray-200 shadow-xl overflow-hidden">
                  ...
                  <div className="border-t border-gray-200">
                    <button
                      ...
                      className="w-full px-4 py-3 text-left text-sm font-semibold text-red-600 hover:bg-red-50 cursor-pointer"
                    >
                      Logout
                    </button>
                  </div>
